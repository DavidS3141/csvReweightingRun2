...
void final_fitHF_btagSF_13TeV( bool isCSV = true,
  ...
  TString dirprefix = "Images/Images_2016_8_13_fitHF_" + btagger + "_13TeV" + dirPostFix + "/";
  ...
  std::string histofilename = Form("%s_rwt_fit_hf_v%d_final_2016_8_13" + dirPostFix + ".root",btagger.Data(),iterNum) ;
  ...
  for( int iHist=0; iHist<numHists-1; iHist++ ){
	...
	if( hist_name[iHist]=="csv_ratio_Pt0_Eta0" ){ 
	  h_csv_ratio_final[iHist]->Scale( 1.002657 ); 
	  h_csv_ratio_final_JESUp[iHist]->Scale( 0.999195 ); 
	  h_csv_ratio_final_JESDown[iHist]->Scale( 0.994100 ); 
	  h_csv_ratio_final_LFUp[iHist]->Scale( 1.260447 ); 
	  h_csv_ratio_final_LFDown[iHist]->Scale( 1.149906 ); 
	  h_csv_ratio_final_Stats1Up[iHist]->Scale( 1.001583 ); 
	  h_csv_ratio_final_Stats1Down[iHist]->Scale( 1.003831 ); 
	  h_csv_ratio_final_Stats2Up[iHist]->Scale( 1.001177 ); 
	  h_csv_ratio_final_Stats2Down[iHist]->Scale( 1.004337 ); 
 
	  h_csv_ratio[iHist]->Scale( 1.002657 ); 
	  h_csv_ratio_JESUp[iHist]->Scale( 0.999195 ); 
	  h_csv_ratio_JESDown[iHist]->Scale( 0.994100 ); 
	  h_csv_ratio_LFUp[iHist]->Scale( 1.260447 ); 
	  h_csv_ratio_LFDown[iHist]->Scale( 1.149906 ); 
	  h_csv_ratio_Stats1Up[iHist]->Scale( 1.001583 ); 
	  h_csv_ratio_Stats1Down[iHist]->Scale( 1.003831 ); 
	  h_csv_ratio_Stats2Up[iHist]->Scale( 1.001177 ); 
	  h_csv_ratio_Stats2Down[iHist]->Scale( 1.004337 ); 
	} 
	if( hist_name[iHist]=="csv_ratio_Pt1_Eta0" ){ 
	  h_csv_ratio_final[iHist]->Scale( 0.992052 ); 
	  h_csv_ratio_final_JESUp[iHist]->Scale( 0.997272 ); 
	  h_csv_ratio_final_JESDown[iHist]->Scale( 0.985910 ); 
	  h_csv_ratio_final_LFUp[iHist]->Scale( 1.042547 ); 
	  h_csv_ratio_final_LFDown[iHist]->Scale( 1.022683 ); 
	  h_csv_ratio_final_Stats1Up[iHist]->Scale( 0.990850 ); 
	  h_csv_ratio_final_Stats1Down[iHist]->Scale( 0.993197 ); 
	  h_csv_ratio_final_Stats2Up[iHist]->Scale( 0.991166 ); 
	  h_csv_ratio_final_Stats2Down[iHist]->Scale( 0.992960 ); 
 
	  h_csv_ratio[iHist]->Scale( 0.992052 ); 
	  h_csv_ratio_JESUp[iHist]->Scale( 0.997272 ); 
	  h_csv_ratio_JESDown[iHist]->Scale( 0.985910 ); 
	  h_csv_ratio_LFUp[iHist]->Scale( 1.042547 ); 
	  h_csv_ratio_LFDown[iHist]->Scale( 1.022683 ); 
	  h_csv_ratio_Stats1Up[iHist]->Scale( 0.990850 ); 
	  h_csv_ratio_Stats1Down[iHist]->Scale( 0.993197 ); 
	  h_csv_ratio_Stats2Up[iHist]->Scale( 0.991166 ); 
	  h_csv_ratio_Stats2Down[iHist]->Scale( 0.992960 ); 
	} 
	if( hist_name[iHist]=="csv_ratio_Pt2_Eta0" ){ 
	  h_csv_ratio_final[iHist]->Scale( 0.987986 ); 
	  h_csv_ratio_final_JESUp[iHist]->Scale( 0.988240 ); 
	  h_csv_ratio_final_JESDown[iHist]->Scale( 0.988234 ); 
	  h_csv_ratio_final_LFUp[iHist]->Scale( 1.020032 ); 
	  h_csv_ratio_final_LFDown[iHist]->Scale( 1.008978 ); 
	  h_csv_ratio_final_Stats1Up[iHist]->Scale( 0.987625 ); 
	  h_csv_ratio_final_Stats1Down[iHist]->Scale( 0.988338 ); 
	  h_csv_ratio_final_Stats2Up[iHist]->Scale( 0.986853 ); 
	  h_csv_ratio_final_Stats2Down[iHist]->Scale( 0.989180 ); 
 
	  h_csv_ratio[iHist]->Scale( 0.987986 ); 
	  h_csv_ratio_JESUp[iHist]->Scale( 0.988240 ); 
	  h_csv_ratio_JESDown[iHist]->Scale( 0.988234 ); 
	  h_csv_ratio_LFUp[iHist]->Scale( 1.020032 ); 
	  h_csv_ratio_LFDown[iHist]->Scale( 1.008978 ); 
	  h_csv_ratio_Stats1Up[iHist]->Scale( 0.987625 ); 
	  h_csv_ratio_Stats1Down[iHist]->Scale( 0.988338 ); 
	  h_csv_ratio_Stats2Up[iHist]->Scale( 0.986853 ); 
	  h_csv_ratio_Stats2Down[iHist]->Scale( 0.989180 ); 
	} 
	if( hist_name[iHist]=="csv_ratio_Pt3_Eta0" ){ 
	  h_csv_ratio_final[iHist]->Scale( 0.989752 ); 
	  h_csv_ratio_final_JESUp[iHist]->Scale( 0.988373 ); 
	  h_csv_ratio_final_JESDown[iHist]->Scale( 0.988562 ); 
	  h_csv_ratio_final_LFUp[iHist]->Scale( 1.003638 ); 
	  h_csv_ratio_final_LFDown[iHist]->Scale( 0.999726 ); 
	  h_csv_ratio_final_Stats1Up[iHist]->Scale( 0.989497 ); 
	  h_csv_ratio_final_Stats1Down[iHist]->Scale( 0.989792 ); 
	  h_csv_ratio_final_Stats2Up[iHist]->Scale( 0.988833 ); 
	  h_csv_ratio_final_Stats2Down[iHist]->Scale( 0.990549 ); 
 
	  h_csv_ratio[iHist]->Scale( 0.989752 ); 
	  h_csv_ratio_JESUp[iHist]->Scale( 0.988373 ); 
	  h_csv_ratio_JESDown[iHist]->Scale( 0.988562 ); 
	  h_csv_ratio_LFUp[iHist]->Scale( 1.003638 ); 
	  h_csv_ratio_LFDown[iHist]->Scale( 0.999726 ); 
	  h_csv_ratio_Stats1Up[iHist]->Scale( 0.989497 ); 
	  h_csv_ratio_Stats1Down[iHist]->Scale( 0.989792 ); 
	  h_csv_ratio_Stats2Up[iHist]->Scale( 0.988833 ); 
	  h_csv_ratio_Stats2Down[iHist]->Scale( 0.990549 ); 
	} 
	if( hist_name[iHist]=="csv_ratio_Pt4_Eta0" ){ 
	  h_csv_ratio_final[iHist]->Scale( 0.995049 ); 
	  h_csv_ratio_final_JESUp[iHist]->Scale( 0.994075 ); 
	  h_csv_ratio_final_JESDown[iHist]->Scale( 0.995187 ); 
	  h_csv_ratio_final_LFUp[iHist]->Scale( 1.012519 ); 
	  h_csv_ratio_final_LFDown[iHist]->Scale( 1.008104 ); 
	  h_csv_ratio_final_Stats1Up[iHist]->Scale( 0.995682 ); 
	  h_csv_ratio_final_Stats1Down[iHist]->Scale( 0.994420 ); 
	  h_csv_ratio_final_Stats2Up[iHist]->Scale( 0.993610 ); 
	  h_csv_ratio_final_Stats2Down[iHist]->Scale( 0.996578 ); 
 
	  h_csv_ratio[iHist]->Scale( 0.995049 ); 
	  h_csv_ratio_JESUp[iHist]->Scale( 0.994075 ); 
	  h_csv_ratio_JESDown[iHist]->Scale( 0.995187 ); 
	  h_csv_ratio_LFUp[iHist]->Scale( 1.012519 ); 
	  h_csv_ratio_LFDown[iHist]->Scale( 1.008104 ); 
	  h_csv_ratio_Stats1Up[iHist]->Scale( 0.995682 ); 
	  h_csv_ratio_Stats1Down[iHist]->Scale( 0.994420 ); 
	  h_csv_ratio_Stats2Up[iHist]->Scale( 0.993610 ); 
	  h_csv_ratio_Stats2Down[iHist]->Scale( 0.996578 ); 
	} 
      }
    }
	...
	if( hist_name[iHist]=="csv_ratio_Pt0_Eta0" ){ 
	  h_cErr1Up->Scale( 0.673221 ); 
	  h_cErr1Down->Scale( 2.701523 ); 
	  h_cErr2Up->Scale( 0.989424 ); 
	  h_cErr2Down->Scale( 1.010804 ); 
	} 
	if( hist_name[iHist]=="csv_ratio_Pt1_Eta0" ){ 
	  h_cErr1Up->Scale( 0.767661 ); 
	  h_cErr1Down->Scale( 1.685012 ); 
	  h_cErr2Up->Scale( 0.994861 ); 
	  h_cErr2Down->Scale( 1.005192 ); 
	} 
	if( hist_name[iHist]=="csv_ratio_Pt2_Eta0" ){ 
	  h_cErr1Up->Scale( 0.763753 ); 
	  h_cErr1Down->Scale( 1.409430 ); 
	  h_cErr2Up->Scale( 0.996346 ); 
	  h_cErr2Down->Scale( 1.003681 ); 
	} 
	if( hist_name[iHist]=="csv_ratio_Pt3_Eta0" ){ 
	  h_cErr1Up->Scale( 0.755345 ); 
	  h_cErr1Down->Scale( 1.196067 ); 
	  h_cErr2Up->Scale( 0.996197 ); 
	  h_cErr2Down->Scale( 1.003832 ); 
	} 
	if( hist_name[iHist]=="csv_ratio_Pt4_Eta0" ){ 
	  h_cErr1Up->Scale( 0.664773 ); 
	  h_cErr1Down->Scale( 1.171734 ); 
	  h_cErr2Up->Scale( 0.996562 ); 
	  h_cErr2Down->Scale( 1.003462 ); 
	} 
      }
    }
