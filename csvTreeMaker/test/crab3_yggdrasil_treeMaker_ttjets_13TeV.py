...
#config.General.requestName = 'Summer16_zjetsAMC_6thJan' ## change
#config.General.requestName = 'Summer16_lowMasszjetsAMC_6thJan' ## change


#config.General.requestName = 'Summer16_ttjets_6thJan' ## change
#config.General.requestName = 'Summer16_zjets_6thJan' ## change
config.General.requestName = 'Summer16_lowMasszjets_6thJan_new' ## change
#config.General.requestName = 'Summer16_singletW_6thJan' ## change
#config.General.requestName = 'Summer16_singletbarW_6thJan' ## change
#config.General.requestName = 'Summer16_WW_6thJan' ## change
...
config.Data.outputDatasetTag = '6thJan_csvRWT_13TeV'
### change user Space 
