...
#config.General.requestName = 'Spring16_ttjets_12thJuly' ## change
#config.General.requestName = 'Spring16_zjetsAMC_12thJuly' ## change
#config.General.requestName = 'Spring16_lowMasszjetsAMC_12thJuly' ## change

#config.General.requestName = 'Spring16_zjets_12thJuly' ## change
#config.General.requestName = 'Spring16_lowMasszjets_12thJuly' ## change
#config.General.requestName = 'Spring16_singletW_12thJulyv2' ## change
#config.General.requestName = 'Spring16_singletbarW_12thJuly' ## change
config.General.requestName = 'Spring16_WW_12thJuly' ## change
...
config.Data.outputDatasetTag = '12thJuly_csvRWT_13TeV'
### change user Space 
