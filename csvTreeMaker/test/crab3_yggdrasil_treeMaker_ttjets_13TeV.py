...
#config.General.requestName = 'Spring16_ttjets_12thJune' ## change
#config.General.requestName = 'Spring16_zjetsAMC_12thJune' ## change
config.General.requestName = 'Spring16_lowMasszjetsAMC_12thJune' ## change

#config.General.requestName = 'Spring16_zjets_12thJune' ## change
#config.General.requestName = 'Spring16_lowMasszjets_12thJune' ## change
#config.General.requestName = 'Spring16_singletW_12thJunev2' ## change
#config.General.requestName = 'Spring16_singletbarW_12thJune' ## change
#config.General.requestName = 'Spring16_WW_12thJune' ## change
...
config.Data.outputDatasetTag = '12thJune_csvRWT_13TeV'
### change user Space 
